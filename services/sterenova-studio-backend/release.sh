...
# Script de release pour Sterenova Studio Backend
...
echo "🚀 Création de la release Sterenova Studio Backend $VERSION"
echo ""
...
if [ $? -eq 0 ]; then
    ...
    if [ $? -eq 0 ]; then
        ...
        echo ""
        echo "🎉 Release Sterenova Studio Backend $VERSION créée avec succès !"
        echo ""
        echo "📋 Prochaines étapes :"
        echo "1. La CI va automatiquement build et push l'image Docker Hub"
        echo "2. Image: sterenova/sterenova-backend:$VERSION"
        ...
        echo ""
        echo "💡 N'oubliez pas de créer la même release dans le repo frontend !"
    else
