...
export default function TestCSSPage() {
  return (
    <PageWrapper 
      title="Test CSS - Sterenova Flux" 
      description="Page de test pour vérifier que le CSS et les composants shadcn fonctionnent avec le design Sterenova"
      showSidebar={false}
    >
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Test de la Responsivité</CardTitle>
            <CardDescription>
              Vérification que le design s'adapte à toutes les tailles d'écran
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="bg-muted p-4 rounded-lg text-center">
                ...
                <p className="text-sm text-muted-foreground">1 colonne</p>
              </div>
              <div className="bg-muted p-4 rounded-lg text-center">
                <p className="font-medium">Tablet</p>
                <p className="text-sm text-muted-foreground">2 colonnes</p>
              </div>
              <div className="bg-muted p-4 rounded-lg text-center">
                <p className="font-medium">Desktop</p>
                <p className="text-sm text-muted-foreground">4 colonnes</p>
              </div>
              <div className="bg-muted p-4 rounded-lg text-center">
